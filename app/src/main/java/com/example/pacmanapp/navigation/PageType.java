...
import com.example.pacmanapp.MainActivity;
...
public enum PageType {
    INSPECT(R.id.inspectOption, R.id.pageMarkerInspect, InspectActivity.class, EditActivity.class),
    MAP(R.id.mapOption, R.id.pageMarkerMap, MainActivity.class, MainActivity.class),
    SETTINGS(R.id.settingsOption, R.id.pageMarkerSettings, MainActivity.class, MainActivity.class);
